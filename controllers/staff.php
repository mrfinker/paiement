...
class Staff extends Controller
{
    public function __construct()
    {
        parent::__construct();
        Session::init();
        $this->view->js = array("staff/js/staff.js");
    }

    public function all_employee()
    {
        $this->view->userc = $this->model->getAllUsersByCreatorAndCompany();
        $this->view->render('staff/all_employee', true);
    }

    public function departements()
    {
        $this->view->render('staff/departements', true);
    }
    public function designation()
    {
        $this->view->render('staff/designation', true);
    }
    public function roles()
    {
        $this->view->render('staff/roles', true);
    }
    public function dayoffnation()
    {
        $this->view->render('staff/dayoffnation', true);
    }
    public function office_shifts()
    {
        $this->view->render('staff/office_shifts', true);
    }
    public function paie()
    {
        $this->view->render('staff/paie', true);
    }
    // public function history_paiement()
    // {
    //     $this->view->render('staff/history_paiement', true);
    // }
    public function generate_paie_pdf()
    {
        $this->view->render('staff/generate_paie_pdf', true);
    }
    public function generate_pdf()
    {
        $this->view->render('staff/generate_pdf', true);
    }
    public function generate_excel()
    {
        $this->view->render('staff/generate_excel', true);
    }
    public function generate_presence_pdf()
    {
        $this->view->render('staff/generate_presence_pdf', true);
    }
    public function generate_presence_excel()
    {
        $this->view->render('staff/generate_presence_excel', true);
    }
    public function generate_report_paie_annuel_pdf()
    {
        $this->view->render('staff/generate_report_paie_annuel_pdf', true);
    }
    public function generate_report_paie_annuel_excel()
    {
        $this->view->render('staff/generate_report_paie_annuel_excel', true);
    }
    public function generate_dgi_pdf()
    {
        $this->view->render('staff/generate_dgi_pdf', true);
    }
    public function generate_cnss_pdf()
    {
        $this->view->render('staff/generate_cnss_pdf', true);
    }
    public function invoice_paie()
    {
        $this->view->render('staff/invoice_paie', true);
    }
    ...
    //     $this->view->render('staff/invoice_account', true);
    // }

    // public function getAllAccountsByCreatorAndstaff_hack()
    // {
    //     if (isset($_POST["account_id"]) && !empty($_POST["account_id"])) {
    //         $get = $this->model->getAllAccountsByCreatorAndstaff_hack($_POST["account_id"]);
    //         if (!empty($get)) {
    ...
    {
        $this->view->render('staff/invoice_avance', true);
    }
    // public function invoice_transaction()
    // {
    //     $this->view->render('staff/invoice_transaction', true);
    // }
    // public function comptes()
    // {
    //     $this->view->render('staff/comptes', true);
    // }
    // public function depenses()
    // {
    //     $this->view->render('staff/depenses', true);
    // }
    // public function depots()
    // {
    //     $this->view->render('staff/depots', true);
    // }
    // public function transactions()
    // {
    //     $this->view->render('staff/transactions', true);
    // }
    // public function depense_depot()
    // {
    //     $this->view->render('staff/depense_depot', true);
    // }
    public function timesheet()
    {
        $this->view->render('staff/timesheet', true);
    }
    public function report_monthly()
    {
        $this->view->render('staff/report_monthly', true);
    }
    public function avance_salaire()
    {
        $this->view->render('staff/avance_salaire', true);
    }
    public function report_paie_annuel()
    {
        $this->view->render('staff/report_paie_annuel', true);
    }
    public function dgi()
    {
        $this->view->render('staff/dgi', true);
    }
    public function cnss()
    {
        $this->view->render('staff/cnss', true);
    }
    public function onem()
    {
        $this->view->render('staff/onem', true);
    }
    public function inpp()
    {
        $this->view->render('staff/inpp', true);
    }
