                    ...
                    <div class="nk-header-wrap">
                        ...
                        <div class="nk-header-brand">
                            <a href="html/index.html" class="logo-link">
                                <img class="logo-light logo-img" src="<?=URL?>public/images/logo.png" srcset="<?=URL?>images/logo2x.png 2x" alt="logo">
                                            ...
                                            <div class="card-inner-group" data-simplebar>
                                                ...
                                                <div class="card-inner p-0">
                                                    <ul class="link-list-menu">
                                                        <li><a class="active" href="html/user-profile-regular.html"><em class="icon ni ni-user-fill-c"></em><span>Infomation personnel</span></a></li>
                                                    </ul>
                                                </div><!-- .card-inner -->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-lg">
                    <h5 class="title">Mettre a jour</h5>
                    <ul class="nk-nav nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#personal">Personnel</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#address">Adresse</a>
                        </li>
                    </ul><!-- .nav-tabs -->
                    <div class="tab-content">
                        <div class="tab-pane active" id="personal">
                        <form id="Updateinfo" action="" method="post">
                            <div class="row gy-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="full-name">Noms</label>
                                        <input type="text" class="form-control form-control-lg" name="name" id="full-name" value="<?=$user['name']?>" placeholder="Enter Full name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="display-name">Nom d'utilisateur</label>
                                        <input type="text" class="form-control form-control-lg" name="username" id="display-name" value="<?=$user['username']?>" placeholder="Enter display name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="phone-no">Telephone</label>
                                        <input type="text" class="form-control form-control-lg" name="phone" id="phone-no" value="<?=$user['phone']?>" placeholder="Phone Number">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="birthday">Date d'anniversaire</label>
                                        <input type="text" class="form-control form-control-lg date-picker" name="birthday" id="birthday" placeholder="<?=$user['birthday']?>">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                        <li>
                                            <button href="#" id="Updateinfo_btn" type="submit" data-bs-dismiss="modal" class="btn btn-lg btn-primary">Mettre a jour</button>
                                        </li>
                                        <li>
                        ...
                        <div class="tab-pane" id="address">
                            <div class="row gy-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="address-l1">Adresse</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="address-county">Pays</label>
                                ...
                                <div class="col-12">
                                    <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                        <li>
                                            <a href="#" class="btn btn-lg btn-primary" type="submit" id="Updateadresse">Mettre a jour</a>
                                        </li>
                                        <li>
                                            <a href="#" data-bs-dismiss="modal" class="link link-light">Cancel</a>
                                        </li>
