                ...
                <form id="payeFormUsercomp" method="POST">
                    <div class="row gy-4">
                        ...
                        <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="number" class="form-control form-control-lg" id="absent_days" name="absent_days" placeholder="Jours d'absence">
                                </div>
                            </div>
                        </div>
                        <div>
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="col-sm-10">
                                <!-- <div class="tb-item d-flex justify-content-between">
                                <span class="nk-col tb-col-sm">Allocation</span>
                                <span class="nk-col tb-col-sm">0 $</span>
                            </div> -->
                            <div class="tb-item d-flex justify-content-between m-1">
                                <span class="nk-col tb-col-sm primary">Salaire brut imposable</span>
                                <h3 class="nk-col tb-col-sm" style="font-size: large;" id="salary_imposable"></h3>
                            </div>
                            <div class="tb-item d-flex justify-content-between m-1">
                                <span class="nk-col tb-col-sm primary">Salaire net imposable</span>
                                <h3 class="nk-col tb-col-sm" style="font-size: large;" id="net_before_taxes"></h3>
                            </div>
                            <div class="tb-item d-flex justify-content-between m-1">
                                <span class="nk-col tb-col-sm primary">IPR</span>
                                <h3 class="nk-col tb-col-sm" style="font-size: large;" id="ipr"></h3>
                            </div>
                            <div class="tb-item d-flex justify-content-between m-1">
                                <span class="nk-col tb-col-sm primary">Salaire apres deduction</span>
                                <h3 class="nk-col tb-col-sm" style="font-size: large;" id="net_after_taxes"></h3>
                            </div>
                            <div class="tb-item d-flex justify-content-between m-1">
                                <span class="nk-col tb-col-sm primary">Maison</span>
                                <h3 class="nk-col tb-col-sm" style="font-size: large;" id="housing"></h3>
                            </div>
                            <div class="tb-item d-flex justify-content-between m-1">
                                <span class="nk-col tb-col-sm primary">Transport</span>
                                <h3 class="nk-col tb-col-sm" style="font-size: large;" id="transport"></h3>
                            </div>
                            <div class="tb-item d-flex justify-content-between m-1">
                                <span class="nk-col tb-col-sm primary">CNSS</span>
                                <h3 class="nk-col tb-col-sm" style="font-size: large;" id="cnss"></h3>
                            </div>
                            <div class="tb-item d-flex justify-content-between m-1">
                                <span class="nk-col tb-col-sm primary">Salaire net</span>
                                <h3 class="nk-col tb-col-sm" style="font-size: large;" id="salary_net"></h3>
                            </div>
                            <div class="tb-item d-flex justify-content-between m-1">
                                <span class="nk-col tb-col-sm primary">Salaire</span>
                                <h3 class="nk-col tb-col-sm" style="font-size: large;" id="final_salary"></h3>
                            </div>
                            <label class="divider"></label>
                            <div class="tb-item d-flex justify-content-between m-1">
                                <span class="nk-col tb-col-sm primary">CNSS company</span>
                                <h3 class="nk-col tb-col-sm" style="font-size: large;" id="cnss_company"></h3>
                            </div>
                            <div class="tb-item d-flex justify-content-between m-1">
                                <span class="nk-col tb-col-sm primary">IERE</span>
                                <h3 class="nk-col tb-col-sm" style="font-size: large;" id="iere"></h3>
                            </div>
                            <div class="tb-item d-flex justify-content-between m-1">
                                <span class="nk-col tb-col-sm primary">INPP</span>
                                <h3 class="nk-col tb-col-sm" style="font-size: large;" id="inpp"></h3>
                            </div>
                            <div class="tb-item d-flex justify-content-between m-1">
                                <span class="nk-col tb-col-sm primary">ONEM</span>
                                <h3 class="nk-col tb-col-sm" style="font-size: large;" id="onem"></h3>
                            </div>
                            <div class="tb-item d-flex justify-content-between m-1">
                                <span class="nk-col tb-col-sm primary">Salaire brute company</span>
                                <h3 class="nk-col tb-col-sm" style="font-size: large;" id="salary_brut_company"></h3>
                            </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <textarea required class="form-control no-resize" id="default-textarea" placeholder="Les raisons du paiement"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
