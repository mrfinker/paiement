                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="dt-export-buttons d-flex align-center mb-3 d-flex justify-content-end">
                            ...
                            <div class="dt-buttons btn-group flex-wrap">
                                <button id="download-pdf-cnss" class="btn btn-secondary buttons-pdf buttons-html5 cnss_info" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Pdf" data-bs-original-title="Pdf" tabindex="0" aria-controls="DataTables_Table_2" type="button">
                                    <span>PDF</span>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="row gy-4 mb-4 d-flex align-conten">
                            ...
                            <div class="col-lg-2 col-sm-4">
                                <button href="#" id="cnssData" class="btn-lg btn btn-primary" onclick="filterData()">
                                    <span>Filtrer</span>
                                    ...
                                    <table class="datatable-init nk-tb-list nk-tb-ulist dataTable no-footer" data-auto-responsive="false" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                                        <thead>
                                            <tr class="nk-tb-item nk-tb-head">
                                                ...
                                                <th class="nk-tb-col sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Phone: activate to sort column ascending">
                                                    <span class="sub-text">cnss</span>
                                                </th>
                                                <th class="nk-tb-col sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Phone: activate to sort column ascending">
                                                    <span class="sub-text">cnss company</span>
                                                </th>
                                        ...
                                        <tbody id="paiement_users">
                                            ...
                                            ?>
                                                ...
                                                <tr class="nk-tb-item odd">
                                                    ...
                                                    <td class="nk-tb-col">
                                                        <span><?= $usercomp['cnss'] ?></span>
                                                    </td>
                                                    <td class="nk-tb-col">
                                                        <span><?= $usercomp['cnss_company'] ?></span>
                                                    </td>
...
<script>
    ...
    document.getElementById('download-pdf-cnss').addEventListener('click', async function(event) {
        ...
        try {
            let response = await fetch('<?= URL; ?>company/generatecnssPdfAjax', {
                method: 'POST',
                headers: {
...
<script>
    ...
    document.getElementById('cnssData').addEventListener('click', function() {
        var year = document.getElementById('year-select').value;
        var month = document.getElementById('month-select').value;

        var xhr = new XMLHttpRequest();
        xhr.open('POST', '<?= URL; ?>company/cnss_searchData', true);
...
<script>
    function filterData() {
        ...
        var xhr = new XMLHttpRequest();
        xhr.open('POST', '<?= URL; ?>company/cnss_search', true);
        xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
        xhr.onload = function() {
            if (this.status == 200) {
