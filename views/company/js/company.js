$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status === 200) {
                    ...
                    Swal
                        .fire({
                            icon: "success", title: "Enregistrement réussi", text: res.msg, timer: 500, // Vous pouvez ajuster le temps comme vous le souhaitez.
                            timerProgressBar: true,
                            willOpen: () => {
                                Swal.showLoading()
                                timerInterval = setInterval(() => {
    ...
    $(document).ready(function () {
        ...
        document
            ...
            .textContent = phone;
        document
            .getElementById('invoice_date_value')
            .textContent = year_to_date;
        document
            .getElementById('payslip_code')
            .textContent = payslip_code;
        document
            .getElementById('payslip_code_')
            .textContent = payslip_code_;
        document
            .getElementById('salary_month')
            .textContent = salary_month;
        document
