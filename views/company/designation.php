                        ...
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                ...
                                <button
                                    ...
                                    data-bs-target="#newFormDesignation">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li>
                                                                            ...
                                                                            <a
                                                                                href="#"
                                                                                class="update_button_designation"
                                                                                data-id="<?=$branche['designation_id'];?>"
                                                                                data-designation-name="<?=$branche['designation_name'];?>"
                                                                                data-designation-depname="<?=$branche['department_name'];?>">
...
?>
                    ...
                    <div class="form-group mt-2">
                        <button
                            type="submit"
                            name="register_btn"
                            class="btn btn-lg btn-primary btn-block">Cree branche
                        </button>
                    </div>
                </form>
            </div>
