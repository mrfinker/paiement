                        ...
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                ...
                                <button
                                    ...
                                    data-bs-target="#newFormTimesheet">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li>
                                                                            <a
                                                                                href="#"
                                                                                class="delete-button-timesheet"
                                                                                data-id="<?=$timesheet['timesheet_id'];?>">
                                                                                <em class="icon ni ni-trash"></em>
                                                                                <span>Supprimer</span>
                                                                            </a>
                                                                            <a
                                                                                href="#"
                                                                                class="update_button_timesheet"
                                                                                data-id="<?=$timesheet['timesheet_id'];?>"
                                                                                data-timesheet_date="<?=$timesheet['timesheet_date'];?>"
                                                                                data-timesheet_clockin="<?=$timesheet['clock_in'];?>"
                                                                                data-timesheet_clockout="<?=$timesheet['clock_out'];?>"
                                                                                data-timesheet_staffid="<?=$timesheet['staff_id'];?>">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input
                                        type="text"
                                        name="timesheet_date_update"
                                        placeholder="2023-10-23"
                                        class="form-control form-control-lg form-control-outlined date-picker"
                                        id="timesheet_date_update">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
