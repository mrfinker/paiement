...
<div class="nk-content ">
                                ...
                                <div class="nk-block nk-block-lg">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            ...
                                            <button href="#" class="btn btn-primary mt-2" type="button" data-bs-toggle="modal" data-bs-target="#modalFormCompany">
                                            ...
                                            <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                                ...
                                                <tr class="nk-tb-item odd">
                                                        ...
                                                        <td class="nk-tb-col">
                                                            <div class="user-card">
                                                                <div class="user-info">
                                                                    <span class="tb-lead"> <?= $compagni['id'] ?> <span class=" d-md-none ms-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                ...
                                                                                <li class="divider"></li>
                                                                                <li>
                                                                                    <a href="#" class="update-button" data-id="<?= $compagni['id']; ?>" data-bs-toggle="modal" data-bs-target="#UpdateModal">
                                                                                    <em class="icon ni ni-trash"></em>
                ...
                <div class="modal fade" id="modalFormCompany" style="display: none;" aria-hidden="true">
