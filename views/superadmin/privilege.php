                                        ...
                                        <thead>
                                            <tr class="nk-tb-item nk-tb-head">
                                                ...
                                                <th class="nk-tb-col nk-tb-col-tools text-end sorting" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="
                                                    : activate to sort column ascending"><span>Action</span></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            ?>
                                                ...
                                                <tr class="nk-tb-item odd">
                                                    ...
                                                    <td class="nk-tb-col tb-col-md">
                                                        <span><?= $userRole['permissions'] ?></span>
                                                    </td>
                                                    <td class="nk-tb-col tb-col-md">
                                                                ...
                                                                <div class="drodown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            <li>
                                                                                <a href="#" class="delete-button" data-id="<?= $userRole['id_role']; ?>">
                                                                            ...
                                                                            <li class="divider"></li>
                                                                            <li>
                                                                                <a href="#" class="update_button" data-userrole-name="<?= $userRole['nom'] ?>" data-id="<?= $userRole['id_role']; ?>">
