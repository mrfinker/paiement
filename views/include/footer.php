...
<script>
    ...
    new Chart(document.getElementById("line-chart"), {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: <?php echo json_encode($iereData); ?>,
                label: "IERE",
                borderColor: "#2da532",
                fill: false
            }, {
                data: <?php echo json_encode($inppData); ?>,
                label: "INPP",
                borderColor: "#dd4548",
                fill: false
            }, {
                data: <?php echo json_encode($onemData); ?>,
                label: "ONEM",
                borderColor: "#f1c40f",
                fill: false
            }]
    ...
    new Chart(document.getElementById("line-chart2"), {
        ...
        data: {
            ...
            datasets: [{
                data: <?php echo json_encode($salaryBrutCompanyData); ?>,
                label: "SALAIRE BRUT COMPANY",
                borderColor: "#4a235a",
                fill: false
            }, {
                data: <?php echo json_encode($salaryNetData); ?>,
                label: "SALAIRE NET",
                borderColor: "#00ff7f",
                fill: false
            }]
...
<script>
    let inactivityTime = function() {
        ...
        function logout() {
            fetch("<?= URL ?>login/logout") // Modifiez avec le chemin correct
                .then(() => window.location.reload()) // Recharge la page
                .catch((error) => console.error('Erreur lors de la déconnexion:', error));
        }

        // Utilisez addEventListener au lieu de on-event
