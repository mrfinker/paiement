                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                ...
                                <button href="#" class="btn btn-primary mt-2" type="button" data-bs-toggle="modal" data-bs-target="#newFormComptes">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            <li>
                                                                                ...
                                                                                <a href="#" class="update_button_comptes" data-id="<?= $account['account_id']; ?>" data-comptes-name="<?= $account['account_name']; ?>" data-comptes-number="<?= $account['account_number']; ?>" data-comptes-balance="<?= $account['account_balance']; ?>" data-comptes-bank_name="<?= $account['bank_name']; ?>">
                                                                                    <em class="icon ni ni-pen"></em>
                                                                                    <span>Modifier</span>
                                                                                </a>
                                                                                <a href="#" class="view_button_comptes" data-id="<?= $account['account_id']; ?>" data-account_code="<?= $account['account_code']; ?>" data-account_value="<?= $account['account_value']; ?>" data-account_name="<?= $account['account_name']; ?>" data-creator_name="<?= $account['creator_name']; ?>" data-account_number="<?= $account['account_number']; ?>" data-created_at="<?= $account['created_at']; ?>" data-bank_name="<?= $account['bank_name']; ?>">
...
<div class="modal fade" id="newFormComptes" style="display: none;" aria-hidden="true">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input required="required" type="text" name="account_name" class="form-control form-control-lg" id="account_name" placeholder="Entrer le nom du compte bancaire">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input required="required" type="text" name="account_number" class="form-control form-control-lg" id="account_number" placeholder="Entrer le numero de compte">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input required="required" type="text" name="account_balance" class="form-control form-control-lg" id="account_balance" placeholder="Entrer le montant initial du compte">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input required="required" type="text" name="bank_name" class="form-control form-control-lg" id="bank_name" placeholder="Entrer le nom de la banque">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group mt-2">
                        <button type="submit" name="register_btn" class="btn btn-lg btn-primary btn-block">Cree compte
                        </button>
                    </div>
                </form>
            </div>
...
<!-- update departements -->
<div class="modal fade" id="UpdateModalComptes" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-mb" role="document">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <div class="row gy-4">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input required="required" type="text" name="compteNameUpdate" class="form-control form-control-lg" id="compteNameUpdate" placeholder="Entrer votre noms">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input required="required" type="text" name="compteNumberUpdate" class="form-control form-control-lg" id="compteNumberUpdate" placeholder="Entrer votre noms">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input required="required" type="text" name="compteBalanceUpdate" class="form-control form-control-lg" id="compteBalanceUpdate" placeholder="Entrer votre noms">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input required="required" type="text" name="compteBankNameUpdate" class="form-control form-control-lg" id="compteBankNameUpdate" placeholder="Entrer votre noms">
                                </div>
                            </div>
                        </div>
                    </div>
