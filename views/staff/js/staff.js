$(document).ready(function () {
  ...
  $(document).on("click", "#btn_add_roles", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/handleAddRole`,
      type: "POST",
      dataType: "JSON",
      data: {
        name: name,
  ...
  $(document).on("click", ".delete-button-deleteRole", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/handleDeleteRole`,
      type: "POST",
      dataType: "JSON",
      data: {
        id_role,
  ...
  $(document).on("submit", "#registerFormDepartements", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/handleAddDepartment`, // Remplacez par l'URL appropriée de votre contrôleur
      type: "POST",
      dataType: "JSON",
  ...
  $(document).on("click", ".delete-button-deleterDepartment", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/handleDeleteDepartement`, // Notez le changement d'URL ici
      type: "POST",
      dataType: "JSON",
      data: {
        id,
  ...
  $(document).on("submit", "#updateFormDepartements", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/updateDepartment`,
      type: "POST",
      dataType: "JSON",
      processData: false,
      contentType: false,
  ...
  $(document).on("submit", "#registerFormDesignation", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/handleAddDesignation`, // Remplacez par l'URL appropriée de votre contrôleur
      type: "POST",
      dataType: "JSON",
      processData: false, // Important pour envoyer les données du formulaire avec FormData
      contentType: false, // Important pour envoyer les données du formulaire avec FormData
  ...
  $(document).on("click", ".delete-button-deleterBranche", function (e) {
    ...
    let id = parseInt($(".id_users").val());
    $.ajax({
      url: `${baseUrl}staff/handleDeleteDesignation`, // Notez le changement d'URL ici
      type: "POST",
      dataType: "JSON",
      data: {
        id,
  ...
  $(document).on("submit", "#updateFormDesignation", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/updateDesignation`, // Correction du nom de la méthode
      type: "POST",
      dataType: "JSON",
      processData: false,
      contentType: false,
  ...
  $(document).ready(function () {
    $('select[name="department_id"]').on("change", function () {
      ...
      if (departmentId) {
        $.ajax({
          url: `${baseUrl}staff/handleAjaxRequest`,
          type: "POST",
          data: {
  ...
  //   $.ajax({
  //     url: `${baseUrl}staff/handleAddDepExp`, // Remplacez par l'URL appropriée de votre contrôleur
  //     type: "POST",
  //     dataType: "JSON",
  //     processData: false, // Important pour envoyer les données du formulaire avec FormData
  //     contentType: false, // Important pour envoyer les données du formulaire avec FormData
  ...
  //   let id = parseInt($(this).data("id"));
  //   $.ajax({
  //     url: `${baseUrl}staff/handleDeleteCategoryDepExp`, // Notez le changement d'URL ici
  //     type: "POST",
  //     dataType: "JSON",
  //     data: {
  //       id,
  ...
  //   $.ajax({
  //     url: `${baseUrl}staff/updateDepExp`, // Correction du nom de la méthode
  //     type: "POST",
  //     dataType: "JSON",
  //     processData: false,
  //     contentType: false,
  ...
  //   $.ajax({
  //     url: `${baseUrl}staff/handleAddDepenses`,
  //     method: "POST",
  //     dataType: "JSON",
  //     data: {
  //       account_name,
  ...
  //   $.ajax({
  //     url: `${baseUrl}staff/handleAddDepots`,
  //     method: "POST",
  //     dataType: "JSON",
  //     data: {
  //       account_name,
  ...
  //   let id = parseInt($(this).data("id"));
  //   $.ajax({
  //     url: `${baseUrl}staff/handleDeleteTransactionDepExp`, // Notez le changement d'URL ici
  //     type: "POST",
  //     dataType: "JSON",
  //     data: {
  //       id,
  ...
  //   $.ajax({
  //     url: `${baseUrl}staff/updateTransactions`, // Correction du nom de la méthode
  //     type: "POST",
  //     dataType: "JSON",
  //     processData: false,
  //     contentType: false,
  ...
  $(document).on("submit", "#registerFormTime", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/handleAddHoraire`, // Assurez-vous que c'est la bonne URL pour votre méthode de contrôleur.
      type: "POST",
      dataType: "JSON",
      processData: false,
      contentType: false,
  ...
  $(document).on("click", ".delete-button-deleteOffice", function (e) {
    ...
    let id = parseInt($(".id_users").val());
    $.ajax({
      url: `${baseUrl}staff/handleDeleteHoraire`, // Notez le changement d'URL ici
      type: "POST",
      dataType: "JSON",
      data: {
        id,
  ...
  $(document).ready(function () {
    ...
    $(document).on("submit", "#updateFormTime", function (e) {
      ...
      $.ajax({
        url: `${baseUrl}staff/updateHoraire`,
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
  ...
  $(document).on("click", ".delete-button-usercompp", function (e) {
    ...
    let id = parseInt($(".id_users").val());
    $.ajax({
      url: `${baseUrl}staff/handleDeleteUserscomp`,
      type: "POST",
      dataType: "JSON",
      data: {
        id,
  ...
  $(document).on("submit", "#registerFormUserCompany", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/handleRegisterUsers`,
      type: "POST",
      dataType: "JSON",
      data: formData,
      processData: false,
  ...
  $(document).on("click", "#confirmPayement", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/handleAddPayments`, // Remplacez par l'URL appropriée de votre contrôleur
      type: "POST",
      dataType: "JSON",
      processData: false, // Important pour envoyer les données du formulaire avec FormData
      contentType: false, // Important pour envoyer les données du formulaire avec FormData
  ...
  $(document).on("click", ".facture_button_usercomp", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/generatePaiePdfAjax`,
      type: "POST",
      data: data,
  ...
  //   let url = `${baseUrl}staff/invoice_account`;
  ...
  //   $.ajax({
  //     url: `${baseUrl}staff/getAllAccountsByCreatorAndCompany_hack`,
  //     type: "POST",
  //     dataType: "JSON",
  //     data: {
  //       account_id,
  ...
  //   let url = `${baseUrl}staff/invoice_transaction?transaction=${transactions_value}?linked-solution?`;
  //   window.open(url, "_blank");
  // });
...
$(document).on("click", ".voir_button_advanced", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/generateAvancePdfAjax`,
      type: "POST",
      data: data,
      success: function (response) {
        // Ouvre l'URL dans un nouvel onglet
  ...
  $(document).on(
    ...
    function (e) {
      ...
      // AJAX Request
      $.ajax({
        url: `${baseUrl}staff/updateStatus`, // Assurez-vous que l'URL est correcte
        type: "POST",
        dataType: "JSON",
        processData: false,
        contentType: false,
  ...
  $(document).on("submit", "#registerFormComptes", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/handleAddComptes`, // Remplacez par l'URL appropriée de votre contrôleur
      type: "POST",
      dataType: "JSON",
      processData: false, // Important pour envoyer les données du formulaire avec FormData
      contentType: false, // Important pour envoyer les données du formulaire avec FormData
  ...
  $(document).on("click", ".delete-button-comptes", function (e) {
    ...
    let id = parseInt($(this).data("id"));
    $.ajax({
      url: `${baseUrl}staff/handleDeleteComptes`, // Notez le changement d'URL ici
      type: "POST",
      dataType: "JSON",
      data: {
        id,
  ...
  $(document).on("submit", "#updateFormCompte", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/updateComptes`,
      type: "POST",
      dataType: "JSON",
      processData: false,
      contentType: false,
  ...
  $(document).on("submit", "#registerFormTimesheet", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/handleAddTimesheet`, // Remplacez par l'URL appropriée de votre contrôleur
      type: "POST",
      dataType: "JSON",
      processData: false, // Important pour envoyer les données du formulaire avec FormData
      contentType: false, // Important pour envoyer les données du formulaire avec FormData
  ...
  $(document).on("click", ".delete-button-deleterPresence", function (e) {
    ...
    let id = parseInt($(".id_users").val());
    $.ajax({
      url: `${baseUrl}staff/handleDeleteTimesheet`, // Notez le changement d'URL ici
      type: "POST",
      dataType: "JSON",
      data: {
        id,
  ...
  $(document).on("submit", "#updateFormTimesheet", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/updateTimesheet`,
      type: "POST",
      dataType: "JSON",
      processData: false,
      contentType: false,
  ...
  $(document).on("submit", "#registerFormAvanceSalaire", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/handleAddavanceSalaire`,
      method: "POST",
      dataType: "JSON",
      data: {
        advance_amount,
  ...
  $(document).on("click", ".delete-button-avanceSalaire", function (e) {
    ...
    let id = parseInt($(".id_users").val());
    $.ajax({
      url: `${baseUrl}staff/handleDeleteAvanceSalaire`, // Notez le changement d'URL ici
      type: "POST",
      dataType: "JSON",
      data: {
        id,
  ...
  $(document).on("submit", "#updateFormAdvanceSalaire", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/updateAvanceSalaire`,
      type: "POST",
      dataType: "JSON",
      processData: false,
      contentType: false,
  ...
  $(document).ready(function () {
    ...
    $("#staff_id").change(function () {
      ...
      $.ajax({
        url: `${baseUrl}staff/getOfficeShiftDetailsPresence`, // Modifiez avec l'URL correcte
        type: "GET",
  ...
  $(document).on("submit", "#registerFormDayoff", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/handleAddDayoff`, // Remplacez par l'URL appropriée de votre contrôleur
      type: "POST",
      dataType: "JSON",
      processData: false, // Important pour envoyer les données du formulaire avec FormData
      contentType: false, // Important pour envoyer les données du formulaire avec FormData
  ...
  $(document).on("click", ".delete-button-deleteDayoff", function (e) {
    ...
    let id = parseInt($(".id_users").val());
    $.ajax({
      url: `${baseUrl}staff/handleDeleteDayoff`, // Notez le changement d'URL ici
      type: "POST",
      dataType: "JSON",
      data: {
        id,
  ...
  $(document).on("submit", "#updateFormdayoff", function (e) {
    ...
    $.ajax({
      url: `${baseUrl}staff/updateDayOff`,
      type: "POST",
      dataType: "JSON",
      processData: false,
      contentType: false,
