                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                ...
                                <button href="#" class="btn btn-primary mt-2" type="button" style="height: 35px;" data-bs-toggle="modal" data-bs-target="#newFormDepenses">
...
<!-- Ajouter depenses -->
<div class="modal fade" id="newFormDepenses" style="display: none;" aria-hidden="true">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <select class="form-select js-select2 select2-hidden-accessible" aria-hidden="true" required="required" name="account_name" data-ui="lg">
