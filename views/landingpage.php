...
<head>
    ...
    <!-- Fav Icon  -->
    <link rel="shortcut icon" href="./public/index/images/favicon.png">
    <!-- Page Title  -->
    <title>Accueil</title>
    <!-- StyleSheets  -->
    <link rel="stylesheet" href="./public/index/assets/css/dashlite.css?ver=3.2.0">
    <link id="skin-default" rel="stylesheet" href="./public/index/assets/css/theme.css?ver=3.2.0">
</head>
...
<body class="nk-body bg-white npc-landing ">
                        ...
                        <div class="header-wrap">
                            <div class="header-logo">
                                <a href="html/index.html" class="logo-link">
                                    <img class="logo-light logo-img" src="./public/index/images/logo.png" srcset="./public/index/images/logo2x.png 2x" alt="logo">
                                    <img class="logo-dark logo-img" src="./public/index/images/logo-dark.png" srcset="./public/index/images/logo-dark2x.png 2x" alt="logo-dark">
                                </a>
                            </div>
                            ...
                            <nav class="header-menu" data-content="mainNav">
                                <ul class="menu-list ms-lg-auto">
                                    <li class="menu-item"><a href="#home" class="menu-link nav-link">Accueil</a></li>
                                    <li class="menu-item"><a href="#service" class="menu-link nav-link">Services</a></li>
                                    <li class="menu-item"><a href="#reviews" class="menu-link nav-link">Testimonials</a></li>
                                    <li class="menu-item"><a href="#feature" class="menu-link nav-link">Fonctions</a></li>
                                    <li class="menu-item"><a href="#faqs" class="menu-link nav-link">Faqs</a></li>
                                </ul>
                                <ul class="menu-btns">
                                    <li>
                                        <a href="./app/views/login.php" target="_blank" class="btn btn-primary btn-lg">Connexion</a>
                                    </li>
                                </ul>
                            </nav><!-- .nk-nav-menu -->
                        </div><!-- .header-warp-->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-10">
                                <div class="card overflow-hidden p-2 bg-light">
                                    <img src="../public/index/images/header/gfx-c.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="review">
                                ...
                                <div class="review-brand">
                                    <img src="../public/index/images/brand/brand-f.png" alt="">
                                </div>
                            </div><!-- .review -->
                        </div><!-- .col -->
                        <div class="col-lg-4 col-md-6">
                            <div class="review">
                                ...
                                <div class="review-brand">
                                    <img src="../public/index/images/brand/brand-g.png" alt="">
                                </div>
                            </div><!-- .review -->
                        </div><!-- .col -->
                        <div class="col-lg-4 col-md-6">
                            <div class="review">
                                ...
                                <div class="review-brand">
                                    <img src="../public/index/images/brand/brand-h.png" alt="">
                                </div>
                            </div><!-- .review -->
                        </div><!-- .col -->
                    </div><!-- .row -->
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-5">
                            <div class="img-block img-block-s1 left">
                                <img src="../public/index/images/gfx/a.png" alt="Dashlite">
                            </div>
                        </div><!-- .col -->
                        <div class="col-lg-6">
                    ...
                    <div class="row flex-row-reverse justify-content-between align-items-center">
                        <div class="col-lg-5">
                            <div class="img-block img-block-s1 right">
                                <img src="../public/index/images/gfx/b.png" alt="Dashlite">
                            </div>
                        </div><!-- .col -->
                        <div class="col-lg-6">
    ...
    <!-- app-root @e -->
    <!-- JavaScript -->
    <script src="./public/index/assets/js/bundle.js?ver=3.2.0"></script>
    <script src="./public/index/assets/js/scripts.js?ver=3.2.0"></script>
</body>
